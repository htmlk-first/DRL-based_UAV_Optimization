"""VDN-MADQN Test: loads saved model and regenerates result plots."""
...
if __name__ == "__main__":
    ...
    model_path = os.path.join(RESULTS, "vdn_madqn_model.pt")
    ...
    try:
        ...
        raise RuntimeError(
            "The saved vdn_madqn_model.pt is incompatible with the current "
