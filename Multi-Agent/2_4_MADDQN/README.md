# 2_3_MADDQN: Cooperative Multi-Agent Double DQN

This experiment keeps the 2D cooperative structure from `2_1_MADQN` and
changes the learner from MADQN to MADDQN, using Double DQN target selection.
The original `2_1_MADQN` folder is kept unchanged as the baseline.
...
MADDQN uses one shared Q-network for all UAVs.
...
- Double DQN target: online network selects the next action, target network evaluates it
