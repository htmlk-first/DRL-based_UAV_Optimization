"""Visualization helpers for cooperative multi-UAV MADDPG experiments."""
...
def plot_reward_curve(rewards, window=100, title="MADDPG Training Curve", save_path=None):
...
def plot_success_curve(success_history, window=100, title="MADDPG Success Rate", save_path=None):
...
def plot_loss_curve(losses, window=200, title="MADDPG Training Loss", save_path=None):
    fig, ax = plt.subplots(figsize=(10, 5), dpi=140)
...
def plot_critic_loss(losses, window=200, title="MADDPG Critic Loss", save_path=None):
    plot_loss_curve(losses, window=window, title=title, save_path=save_path)


def plot_actor_loss(losses, window=200, title="MADDPG Actor Loss", save_path=None):
    plot_loss_curve(losses, window=window, title=title, save_path=save_path)
...
def plot_path(env, title="MADDPG - Best Cooperative Path", save_path=None):
...
def make_flight_gif(env, title="MADDPG Cooperative Flight", save_path="flight.gif", fps=5):
