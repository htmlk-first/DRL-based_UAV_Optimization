"""Configuration for the cooperative multi-agent DDPG UAV environment."""
...
class MultiAgentEnvConfig:
    def __init__(self, **kwargs):
        ...
        self.max_step_size = kwargs.get("max_step_size", 1.0)
        self.wp_reach_radius = kwargs.get("wp_reach_radius", 0.75)
        self.collision_radius = kwargs.get("collision_radius", 0.6)
