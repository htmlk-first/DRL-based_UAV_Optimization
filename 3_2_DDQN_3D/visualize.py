...
def plot_reward_curve(rewards, window=50,
    ...
    if len(rewards) >= window:
        ...
        ax.annotate(
            ...
            fontsize=10, color=ACCENT_YELLOW,
...
def plot_loss_curve(losses, window=100,
                    title="DDQN Training Loss", save_path=None):
    fig, ax = plt.subplots(figsize=(12, 4))
    _style_fig(fig)
    _style_ax(ax)
    ...
    ax.set_xlabel("Learning Step", fontsize=13)
